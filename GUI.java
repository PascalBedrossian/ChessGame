...
/**
 * I learned a lot from my chess project. I was first worried about how I was going
 * to make a GUI, but I ended up figuring it out and still have a lot more to learn.
 * My main class for my project that takes care of the flow of the game is my board
 * class. This project took me a considerable time to achieve, but I am happy I learned
 * a lot and gained knowledge from this project. This project was so fun and taught 
 * me a lot of new stuff, that I will probably continue implementing new features in
 * my project later on that I didn't have time to implement during the semester. It was 
 * a very nice experience that helped me understand OOD even more. 
 * 
...
public class GUI extends Application
{
    ...
    public void displayAbout(){
        ...
        infoAlert.setHeaderText(null);
        infoAlert.setContentText("Programmed by Pascal Bedrossian.\n"
    ...
    /**
     * Method that display an illegal message Alert
     * for castling
     */
    ...
    /**
     * Method that will set the boolean setAutomatic in my Board class
     * to true so it will rotate the Board automatically.
     */
